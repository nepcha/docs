...
const FeatureList = [
  {
    ...
    title: "Get useful user insights within a simple interface",
  ...
  },
  {
    ...
    title: "Say bye to cookies. We don’t collect or share user data.",
  ...
  return (
    <div>
      <div className="w-full max-w-screen-3xl overflow-hidden z-10 tailwind-layout mx-auto">
        <Header
          title="Track your website’s visitors without invading their privacy."
        ...
        <FeaturesSection
          ...
          title="You get real-time user behavior data. Your users’ info stays
          private."
        />
        <Banner />
        <FaqSection />
...
export default function GeneralWebsites() {
  const { siteConfig } = useDocusaurusContext();
