...
const FeatureList = [
  {
    ...
    title: "Who, when, where. All in one single dashboard.",
    Svg: require("@site/static/img/settings.svg").default,
    description: [
      <>
        Get a look at how many people visit your website, where from, their
        devices, what pages they go on and how long they stay there. All of this
        information is provided in an easy-to-read dashboard that’s ready-made
        for your tracking needs.
      </>,
      <>
        No need to build a dashboard from scratch. All the info you need is
        right in front of you, and gets updated in real time. Put “Powered by
        Nepcha” in your footer and gain $300 in credit.
      </>,
    ],
  },
  {
    text: "We respect user privacy",
    title: "Find out just what you need about your users. No cookies.",
  ...
  },
  {
    ...
    title: "Set it up in minutes. Keep your website running fast.",
  ...
  return (
    <div>
      <div className="w-full max-w-screen-3xl overflow-hidden z-10 tailwind-layout mx-auto">
        <Header
          title="Track your website’s visitors without invading their privacy. Get $300 worth of credits."
        ...
        <FeaturesSection
          ...
          title="Track your startup website’s traffic. No personal data involved."
        />
        <Banner />
        <FaqSection />
      </div>
