...
const FeatureList = [
  {
    ...
    title: "Website traffic data at a glance. In one dashboard.",
  ...
  },
  {
    ...
    title: "No cookies involved. Personal data stays private.",
  ...
  },
  {
    ...
    title: "Quick and easy to set up. Doesn’t affect load times.",
  ...
  return (
    <div>
      <div className="w-full max-w-screen-3xl overflow-hidden z-10 tailwind-layout mx-auto">
        <Header
          title="A privacy-focused website analytics tool for enterprises."
        ...
        <FeaturesSection
          ...
          title="Get a better understanding of your customer base. No personal data involved."
        />
        <Banner />
        <FaqSection />
      </div>
...
export default function SmallMediumEnterprises() {
  const { siteConfig } = useDocusaurusContext();
