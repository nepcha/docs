...
const FeatureList = [
  {
    ...
    title: "All website traffic data you need. In one dashboard.",
  ...
  },
  {
    ...
    title: "No user data is shared or collected. 0 cookies involved.",
  ...
  },
  {
    ...
    title: "Easy to set up & doesn’t slow your website down",
  ...
  return (
    <div>
      <div className="w-full max-w-screen-3xl overflow-hidden z-10 tailwind-layout mx-auto">
        <Header
          title="A privacy-focused traffic tracker for Web3 websites."
        ...
        <FeaturesSection
          ...
          title="Get real-time user behavior data. All personal info is kept safe and private. "
        />
        <Banner />
        <FaqSection />
      </div>
...
export default function Web3Websites() {
  const { siteConfig } = useDocusaurusContext();
