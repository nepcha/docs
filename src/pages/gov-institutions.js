  ...
  return (
    <div>
      <div className="w-full max-w-screen-3xl overflow-hidden z-10 tailwind-layout mx-auto">
        <Header
          title="A GDPR-compliant user analytics tool for institutional websites."
        ...
        <FeaturesSection
          ...
          title="Find out if your platform reaches who it should. While keeping their info private."
        />
        <Banner />
        <FaqSection />
      </div>
